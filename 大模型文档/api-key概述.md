...
我的api-key是781eec77989041748c33fbe2331b6648.2qeFMlyW7GYFMmwb

```
Authorization: Bearer 781eec77989041748c33fbe2331b6648.2qeFMlyW7GYFMmwb
```
...
<Tabs>
  ...
  `<Tab title="Python SDK(旧)">`
    ...
    **验证安装**
    ...
    ``python  theme={null}     import zhipuai     print(zhipuai.__version__)     ``
